...
import com.enovlab.yoop.ui.main.mytickets.requested.adapter.RequestedItem.OpensOnSaleItem
...
import kotlinx.android.synthetic.main.item_requested_opens_on_sale.*

class RequestedOpensOnSaleViewHolder(parent: ViewGroup,
                                     private val listener: ((RequestedItem) -> Unit)?,
                                     private val archiveListener: ((List<String>) -> Unit)? = null)
    : RequestedBaseViewHolder(inflateView(R.layout.item_requested_opens_on_sale, parent)) {

    fun bind(item: OpensOnSaleItem) {
