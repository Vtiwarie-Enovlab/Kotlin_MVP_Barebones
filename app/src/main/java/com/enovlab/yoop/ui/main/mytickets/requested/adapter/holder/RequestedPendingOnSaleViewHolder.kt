...
import kotlinx.android.synthetic.main.item_requested_pending_on_sale.*

class RequestedPendingOnSaleViewHolder(parent: ViewGroup,
                                       private val listener: ((RequestedItem) -> Unit)?)
    : RequestedBaseViewHolder(inflateView(R.layout.item_requested_pending_on_sale, parent)) {

    fun bind(item: RequestedItem.PendingOnSaleItem) {
