...
import kotlinx.android.synthetic.main.item_requested_try_list.*

class RequestedTryListViewHolder(parent: ViewGroup,
    ...
    : RequestedBaseViewHolder(inflateView(R.layout.item_requested_try_list, parent)) {

    fun bind(item: RequestedItem.TryListItem) {
        ...
        requested_try_next.setOnClickListener {
            detailsListener?.invoke(RequestedAdapter.DetailsData(item.id, MarketplaceType.DRAW))
        }
