...
import com.enovlab.yoop.ui.transaction.ticket.details.adapter.TicketItem.UserItem
...
class TicketUserViewHolder(parent: ViewGroup, val listener: (() -> Unit)? = null)
