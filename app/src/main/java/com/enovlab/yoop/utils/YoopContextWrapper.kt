...
/**
 * Created by Max Toskhoparan on 1/30/2018.
 */
class YoopContextWrapper(base: Context) : ContextWrapper(base) {
    ...
    companion object {
        ...
        fun wrap(context: Context, locale: Locale): ContextWrapper {
            ...
            return YoopContextWrapper(context.createConfigurationContext(config))
        }
